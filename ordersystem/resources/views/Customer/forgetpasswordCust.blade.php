    ...
    <body>
        ...
        <div class="container">
            <div class="row py-3">
                ...
                <div class="col-sm-4">
                    <form method="GET" action="{{route('forgetpasswordCust')}}">
...
<!--                            <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
                        ...
                        <p><label for="custPassword">New Password:</label>
                        ...
                        <div class="text-center pt-3 pb-5">
                            <button type="submit" name="forgetpasswordCust" class="btn btn-warning mx-2">SUBMIT</button>
                        </div>
                    </form>
