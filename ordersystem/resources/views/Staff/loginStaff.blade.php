...
<html>
    ...
    <script>
        function password() {
            var x = document.getElementById("staffLogPassword");
            if (x.type === "password") {
                x.type = "text";
            } else {
                x.type = "password";
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <form method="GET" action="{{route('loginStaff')}}">

                        <p><label for="staffLogEmail">Email:</label>
                            <input type="email" name="staffLogEmail" id="staffLogEmail" size="30" /></p></br>

                        <p><label for="staffLogPassword">Password:</label>
                            <input type="password" name="staffLogPassword" id="staffLogPassword" size="27" /></br>
                            <input type="checkbox" onclick="password()"><small>Show Password</small></p>

                        <div class="text-center py-3">
                            <button type="submit" name="loginStaff" class="btn btn-warning mx-2">LOGIN</button>
                            <button type="reset" value="Reset" class="btn btn-warning mx-2">RESET</button>
                        </div>

                        <div class=" text-center pb-3">
                            <a href="{{url('/Staff/forgetpasswordStaff') }}" class="text-decoration-none">Forgotten Password?</a>
                        </div>

                        <div class="accAsk-link text-center mb-5 pb-5">
                            <label for="staffSignupLink" style="">New to M&#252;M&#252;?</label>
                            <a href="{{url('/Staff/signUpStaff') }}">Sign Up</a>
                        </div>
                    </form>
